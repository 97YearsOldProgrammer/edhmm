    ...
    with tarfile.open(archive_path, 'r:gz') as tar:
        for member in tar.getmembers():
            ...
            if fileobj:
                ...
                try:
                    name, seq = next(isoform2.read_fasta(tmp_path))
                    dons1, accs1 = hints.mgtag_sites(seq, arg.flank, arg.min_exon+1, 39+1)
                    result = hints.run_hmm(arg.hmm, tmp_path)
                    dons2, accs2 = hints.parse(result)
